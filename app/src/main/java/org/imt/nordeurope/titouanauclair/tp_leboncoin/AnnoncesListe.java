...
public class AnnoncesListe extends AppCompatActivity {
    ...
    void createList(){
        ...
        listedAnnonces.add(new AdModel("Autobianchi A112 Abarth", 14900.0, R.drawable.autobianchi_a112_abarth, 1971, "À vendre : Autobianchi A112 Abarth de 1971. Performante et agile, équipée d'un moteur 4 cylindres Abarth. En bon état général, avec environ 95 000 km au compteur. Intérieur préservé, carrosserie soignée. Prix négociable. Parfaite pour les amateurs de conduite sportive des années 70."));
        listedAnnonces.add(new AdModel("Alpine A310", 38900.0, R.drawable.alpine_a310, 1971, "À vendre : Alpine A310 de 1971, une voiture de sport emblématique des années 70. Équipée d'un moteur V6 en position centrale, offrant des performances exceptionnelles. Ce modèle spécifique affiche 80 000 km au compteur et a été soigneusement entretenu. Intérieur en bon état, carrosserie avec quelques traces d'usure. Prix à discuter dans la limite du raisonnable. Une occasion unique de posséder un morceau de l'histoire automobile française."));
        listedAnnonces.add(new AdModel("Fiat 130 Coupé", 11900.0, R.drawable.fiat_130_coupe, 1971, "À vendre : Fiat 130 Coupé de 1971, une élégante voiture de grand tourisme des années 70. Propulsée par un moteur V6, cette Fiat offre une conduite souple et confortable. Affichant un kilométrage de 90 000 km, elle a été méticuleusement entretenue. L'intérieur spacieux et luxueux est en excellent état, tout comme la carrosserie. Prix compétitif et possibilité de négociation. Une pièce rare pour les amateurs de voitures classiques italiennes."));
