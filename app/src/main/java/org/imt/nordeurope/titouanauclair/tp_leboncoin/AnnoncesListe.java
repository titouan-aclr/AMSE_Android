...
public class AnnoncesListe extends AppCompatActivity {
    ...
    void createList(){
        ...
        listedAnnonces.add(new AdModel("Alfa Romeo Alfasud", 12900.0, R.drawable.alfasud, 1972, "0320335576","test6@gmail.com", "À vendre : Alfa Romeo Alfasud de 1972, une berline compacte dynamique et pleine de caractère. Dotée d'un moteur boxer à quatre cylindres, cette Alfasud offre une conduite agile et sportive. Avec seulement 65 000 km au compteur, elle présente un intérieur bien préservé et une carrosserie en bon état. Prix attractif et ouvert à la négociation. Une opportunité idéale pour les passionnés de voitures italiennes classiques."));
